...
# Various initializations, derived attributes, and I/O setup
...
if Justdb_log and master_process:
    import Justdb
    Justdb.init(project=Justdb_project, name=Justdb_run_name, config=config)
